...
export const MENU = [
// Frozen Snacks (per piece, min 10, +5 each step)
  { id: "fz-samoosa-chicken", cat: "frozen", name: "Samoosa (Chicken)", unit: "1 Piece", minQty: 10, step: 5, price: 12, img: "images/fz-samoosa-chicken.png" },
  { id: "fz-samoosa-beef", cat: "frozen", name: "Samoosa (Beef)", unit: "1 Piece", minQty: 10, step: 5, price: 15, img: "images/fz-samoosa-beef.png" },
  { id: "fz-cutlet-chicken", cat: "frozen", name: "Cutlet (Chicken)", unit: "1 Piece", minQty: 10, step: 5, price: 15, img: "images/fz-cutlet-chicken.png" },
  { id: "fz-cutlet-beef", cat: "frozen", name: "Cutlet (Beef)", unit: "1 Piece", minQty: 10, step: 5, price: 18, img: "images/fz-cutlet-beef.png" },
  { id: "fz-unnakaya", cat: "frozen", name: "Unnakaya", unit: "1 Piece", minQty: 10, step: 5, price: 12, img: "images/fz-unnakaya.png" },
  { id: "fz-kallumakaya-plain", cat: "frozen", name: "Kallumakaya (w/o masala)", unit: "1 Piece", minQty: 10, step: 5, price: 18, img: "images/fz-kallumakaya-plain.png" },
  { id: "fz-kallumakaya-masala", cat: "frozen", name: "Kallumakaya (w/ masala)", unit: "1 Piece", minQty: 10, step: 5, price: 20, img: "images/fz-kallumakaya-masala.png" },
  { id: "fz-chicken-roll", cat: "frozen", name: "Chicken Roll", unit: "1 Piece", minQty: 10, step: 5, price: 15, img: "images/fz-chicken-roll.png" },
  // Fried Snacks (per piece, min 10, +5 each step)
  { id: "fr-samoosa-chicken", cat: "fried", name: "Samoosa (Chicken)", unit: "1 Piece", minQty: 10, step: 5, price: 15, img: "images/fr-samoosa-chicken.png" },
  { id: "fr-samoosa-beef", cat: "fried", name: "Samoosa (Beef)", unit: "1 Piece", minQty: 10, step: 5, price: 18, img: "images/fr-samoosa-beef.png" },
  { id: "fr-cutlet-chicken", cat: "fried", name: "Cutlet (Chicken)", unit: "1 Piece", minQty: 10, step: 5, price: 18, img: "images/fr-cutlet-chicken.png" },
  { id: "fr-cutlet-beef", cat: "fried", name: "Cutlet (Beef)", unit: "1 Piece", minQty: 10, step: 5, price: 20, img: "images/fr-cutlet-beef.png" },
  { id: "fr-unnakaya", cat: "fried", name: "Unnakaya", unit: "1 Piece", minQty: 10, step: 5, price: 15, img: "images/fr-unnakaya.png" },
  { id: "fr-kallumakaya", cat: "fried", name: "Kallumakaya", unit: "1 Piece", minQty: 10, step: 5, price: 22, img: "images/fr-kallumakaya.png" },
  { id: "fr-chicken-roll", cat: "fried", name: "Chicken Roll", unit: "1 Piece", minQty: 10, step: 5, price: 20, img: "images/fr-chicken-roll.png" },
